# Business Model: Forging, pressing, stamping and roll-forming of metal; powder metallurgy
...
## Classification
- Repository: `cloud-itonami-isic-2591` ([github.com/cloud-itonami/cloud-itonami-isic-2591](https://github.com/cloud-itonami/cloud-itonami-isic-2591))
- ISIC Rev.5: `2591` — Forging, pressing, stamping and roll-forming of metal; powder metallurgy
- Domain: `:metal-forming/manufacturing`
- Social impact: :worker-safety :materials-safety :resource-efficiency
- Actor: `:metal-forming-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :metal-forming/manufacturing — who wants
...
One managed tenant (:metal-forming/manufacturing):
...
- Do not bypass the `:metal-forming-plant-operations-governor` for production decisions.
