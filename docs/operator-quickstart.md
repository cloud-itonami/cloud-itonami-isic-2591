# Operator Quickstart — Forging, pressing, stamping and roll-forming of metal; powder metallurgy

Shortest path from clone to a verified local dry-run for **ISIC 2591** (`cloud-itonami-isic-2591`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2591.git
cd cloud-itonami-isic-2591
```
...
- Blueprint governor key: `metal-forming-plant-operations-governor`
- Likely source path: `metalforming.governor.cljc`
