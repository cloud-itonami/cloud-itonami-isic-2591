(ns metalforming.phase
  "Phase 0->3 staged rollout for the forging/pressing/stamping/roll-
  forming and powder-metallurgy plant-operations coordination actor.
  ...
  consequence (a forging-press/stamping-press/roll-forming-mill/
  powder-metallurgy-press-and-sinter-line maintenance window means
  production downtime, and the equipment ends up actually touched); it
  is always a human plant supervisor's call.
  `metalforming.governor`'s `forge-press-line-actuate-blocked-
  ...
  where this actor's authority ends. Like every prior sibling's phase-3
...
(defn verdict->disposition
  "Map a Metal Forming Plant Operations Governor verdict to a base
